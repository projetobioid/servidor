...
$(document).on("keypress", "#cpfAgricultor", function(evt){
//    alert("asd");
//        $('.numeroInt').mask('000000000000000');
        $('#cpfAgricultor').mask('000.000.000-00');//,{'translation': {'u': {pattern: /[0123456789.-]/, optional: true, recursive: true}}};
